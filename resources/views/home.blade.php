        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm h-100 border-0 rounded-3 position-relative">
                    <img src="{{ asset('images/Ayodhya_Ram_Mandir_Inauguration_Day_Picture.jpg') }}" class="card-img-top">
                    <div class="card-body">
                        <h5 class="fw-bold text-danger">Ayodhya Ram Mandir Darshan</h5>
                        <p class="text-muted">{{ Str::limit(strip_tags('Ram Janmabhoomi Darshan, Hanuman Garhi, Kanak Bhawan, Saryu Aarti and Dashrath Mahal visit.'), 100) }}</p>
                        <a href="/ayodhya-ram-mandir-darshan-booking-tour-packages" class="stretched-link btn btn-outline-danger btn-sm">Explore More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm h-100 border-0 rounded-3 position-relative">
                    <img src="{{ asset('images/assi.webp') }}" class="card-img-top">
                    <div class="card-body">
                        <h5 class="fw-bold text-danger">Kashi Vishwanath Darshan</h5>
                        <p class="text-muted">{{ Str::limit(strip_tags('Kashi Vishwanath Jyotirlinga, Ganga Aarti, Kaal Bhairav Temple and Annapurna Mandir darshan.'), 100) }}</p>
                        <a href="/kashi-vishwanath-darshan-booking-tour-packages" class="stretched-link btn btn-outline-danger btn-sm">Explore More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm h-100 border-0 rounded-3 position-relative">
                    <img src="{{ asset('images/mahakumbh2.webp') }}" class="card-img-top">
                    <div class="card-body">
                        <h5 class="fw-bold text-danger">Prayagraj Sangam Darshan</h5>
                        <p class="text-muted">{{ Str::limit(strip_tags('Triveni Sangam Snan, Hanuman Mandir, Akshayavat Darshan, Alopi Devi Mandir and temple visits.'), 100) }}</p>
                        <a href="/prayagraj-sangam-kumbh-nagari-darshan-tour-packages" class="stretched-link btn btn-outline-danger btn-sm">Explore More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm h-100 border-0 rounded-3 position-relative">
                    <img src="{{ asset('images/ujjain2.jpg') }}" class="card-img-top">
                    <div class="card-body">
                        <h5 class="fw-bold text-danger">Ujjain Mahakal Darshan</h5>
                        <p class="text-muted">{{ Str::limit(strip_tags('Mahakaleshwar Jyotirlinga Darshan, Bhasma Aarti, Kal Bhairav Temple and Harsiddhi Mata visit.'), 100) }}</p>
                        <a href="/ujjain-mahakal-mandir-booking-tour-packages" class="stretched-link btn btn-outline-danger btn-sm">Explore More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm h-100 border-0 rounded-3 position-relative">
                    <img src="{{ asset('images/baglamukhi-banner3.webp') }}" class="card-img-top">
                    <div class="card-body">
                        <h5 class="fw-bold text-danger">Maa Baglamukhi Darshan & Puja</h5>
                        <p class="text-muted">{{ Str::limit(strip_tags('VIP Darshan, Baglamukhi Hawan, Stambhan Puja and Court Case Victory Anushthan at Nalkheda Dham.'), 100) }}</p>
                        <a href="/maa-baglamukhi-nalkheda-dham-darshan-booking-puja-services" class="stretched-link btn btn-outline-danger btn-sm">Explore More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-sm h-100 border-0 rounded-3 position-relative">
                    <img src="{{ asset('images/omkareshwar.jfif') }}" class="card-img-top">
                    <div class="card-body">
                        <h5 class="fw-bold text-danger">Omkareshwar Jyotirlinga Darshan</h5>
                        <p class="text-muted">{{ Str::limit(strip_tags('Omkareshwar & Mamleshwar Jyotirlinga Darshan, Narmada Aarti, Parikrama and temple visit.'), 100) }}</p>
                        <a href="/omkareshwar-jyotirlinga-darshan-booking-tour-packages" class="stretched-link btn btn-outline-danger btn-sm">Explore More</a>
                    </div>
                </div>
            </div>
        </div>
